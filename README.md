...
|2|[Проверка гипотез по увеличению выручки, оценка результатов А/В-теста](Проверка гипотез по увеличению выручки/приоритизация_гипотез_и_анализ_АВ-теста.ipynb)|Приоритизация гипотез, оценка результатов A/B-тестирования различными методами|A/B-тест, статистический тест, фреймворк, RICE, ICE|
